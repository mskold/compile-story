...
echo "Compiling PDF"
$WKHTML2PDF --margin-top 20 --margin-right 30 --margin-left 30 --margin-bottom 20  --page-size A4 --encoding utf-8 --footer-font-name "Times New Roman" --footer-font-size 9 --footer-right "$title / $author" --footer-center "[page]" "${OUTPUT_DIR}/${short_title}.html" "${OUTPUT_DIR}/${short_title}.pdf"
